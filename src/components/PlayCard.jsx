...
export default function PlayCard(props) {
    ...
    return (
        <div className="bg-gray-100 p-6 my-4">
            <h1 className="text-right mr-4 text-gray-500">2 marks</h1>
            ...
            <div
                ...
                style={getStyle(op[0])}
                className="bg-white cursor-pointer my-4 px-10 shadow-[3px_3px_3px_0px_rgba(0,0,0,0.3)] p-4 rounded-[100px] w-[40%]"
            >
                {op[0]}
            </div>
            <div
